...
/**
 * Clase principal que contiene el menú de interacción con la lista enlazada.
 */
public class Main {
    public static void main(String[] args) {
        LinkedList list = new LinkedList();
        Scanner scanner = new Scanner(System.in);
        int option = 0, data, position;
            ...
            try {
                ...
                switch (option) {
                    ...
                    case 7:
                        ...
                        data = scanner.nextInt();
                        System.out.println(list.contains(data) ? "El valor está en la lista." : "El valor NO está en la lista.");
                        break;
                    case 8:
